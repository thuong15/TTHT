...
<html lang="en">
  ...
  <li class="list-group-item"><a href="LV.php">Louis Vuitton</a></li>
    ...
    <form style="background: #d5dbe9;height:50px;width:100%">
        <div style="line-height:50px;margin-left:200px;font-size:14px; "><a href="index.php">Home </a>› &nbsp;<a> Hướng dẫn mua hàng</div>
    </form>
            <!-- -------body------------------------>
            <main>
<div style="width:50%;margin:auto" class="term-description"><h2>Cách để đặt hàng tại TTHT Eye chỉ với 3 bước đơn giản </h2>
         <p class="mauchu">
        <b>Bước 1 : Chọn sản phẩm cần mua và click vào nút “Thêm Vào Giỏ”</b>  </p>
         <p > Sau khi tìm được sản phẩm cần mua: <br> <ul>
          
       <li> Cách 1: Bạn ấn nút “Thêm Vào Giỏ” trực tiếp tại giao diện trang chủ hoặc danh mục sản phẩm </li> <br>
       <li> Cách 2: Ấn vào sản phẩm xem chi tiết mô tả, nhập số lượng sản phẩm cần mua và ấn nút “Thêm Vào Giỏ”</li> 
      </ul>
      </p>
          </p>
          <p class="mauchu"><b>Bước 2 : Vào giỏ hàng và tiếp tục ấn nút thanh toán</b><br>
             <br>
             Tại góc phải trên cùng của website, nhấp vào nút “Thanh Toán” khi số lượng hàng mua đã đủ. Ngoài ra, bạn có thể ấn nút <br>
              “View Cart” nếu cần nhập lại số lượng hàng, ấn nút “X” vào sản phẩm không muốn mua hoặc nhầm lẫn <br>
              <!-- ---ảnh--- -->
          </p>
          <p>
             <b>Bước 3 : Nhập thông tin mua hàng đầy đủ và ấn nút “Đặt Hàng”</b>
             <br>
             Quý khách nhập đầy đủ thông tin các mục có dấu sao (*) và gi chú nếu cần nhắc nhở thêm,
             <br>
             sau đó ấn nút “Đặt Hàng” để hoàn tất việc mua bán<br>
             <!-- ---ảnh--- -->
             Sau khi tạo đơn hàng thành công, TTHT Plus sẽ gửi email về đơn hàng và sẽ có nhân viên liên <br>
              hệ trực tiếp với quý khách qua điện thoại để xác nhận và giao hàng tới tận tay
  
             TTHT Plus rất vui khi được đồng hành cùng quý khách hàng trong trải nghiệm mua sắm tại đây,<br> 
           <p class="hotro"><b> Nếu có bất cứ vấn đề cần hỗ trợ, quý khách hàng có thể để lại thông tin vào hộp Chat bên phải màn hình
              <br> hoặc liên hệ hotline: ..... để được hỗ trợ nhanh nhất.</b></p> 
          </p> 
  </div>
